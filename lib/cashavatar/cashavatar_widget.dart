...
import 'cashavatar_model.dart';
export 'cashavatar_model.dart';

class CashavatarWidget extends StatefulWidget {
  const CashavatarWidget({Key? key}) : super(key: key);

  @override
  _CashavatarWidgetState createState() => _CashavatarWidgetState();
}

class _CashavatarWidgetState extends State<CashavatarWidget>
    with TickerProviderStateMixin {
  late CashavatarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CashavatarModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'cashavatar'});
  }
