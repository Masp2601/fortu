...
import 'espejomagico_model.dart';
export 'espejomagico_model.dart';

class EspejomagicoWidget extends StatefulWidget {
  const EspejomagicoWidget({Key? key}) : super(key: key);

  @override
  _EspejomagicoWidgetState createState() => _EspejomagicoWidgetState();
}

class _EspejomagicoWidgetState extends State<EspejomagicoWidget>
    with TickerProviderStateMixin {
  late EspejomagicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EspejomagicoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'espejomagico'});
  }
