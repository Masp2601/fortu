...
import 'hielo_model.dart';
export 'hielo_model.dart';

class HieloWidget extends StatefulWidget {
  const HieloWidget({Key? key}) : super(key: key);

  @override
  _HieloWidgetState createState() => _HieloWidgetState();
}

class _HieloWidgetState extends State<HieloWidget>
    with TickerProviderStateMixin {
  late HieloModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HieloModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'hielo'});
  }
