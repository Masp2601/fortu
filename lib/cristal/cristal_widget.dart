...
import 'cristal_model.dart';
export 'cristal_model.dart';

class CristalWidget extends StatefulWidget {
  const CristalWidget({Key? key}) : super(key: key);

  @override
  _CristalWidgetState createState() => _CristalWidgetState();
}

class _CristalWidgetState extends State<CristalWidget>
    with TickerProviderStateMixin {
  late CristalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CristalModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'cristal'});
  }
