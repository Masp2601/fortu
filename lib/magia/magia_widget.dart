...
import 'magia_model.dart';
export 'magia_model.dart';

class MagiaWidget extends StatefulWidget {
  const MagiaWidget({Key? key}) : super(key: key);

  @override
  _MagiaWidgetState createState() => _MagiaWidgetState();
}

class _MagiaWidgetState extends State<MagiaWidget>
    with TickerProviderStateMixin {
  late MagiaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MagiaModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'magia'});
  }
