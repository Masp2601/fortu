...
class _GiftWidgetState extends State<GiftWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'gift'});
  }
