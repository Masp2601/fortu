...
import 'tierraavatar_model.dart';
export 'tierraavatar_model.dart';

class TierraavatarWidget extends StatefulWidget {
  const TierraavatarWidget({Key? key}) : super(key: key);

  @override
  _TierraavatarWidgetState createState() => _TierraavatarWidgetState();
}

class _TierraavatarWidgetState extends State<TierraavatarWidget>
    with TickerProviderStateMixin {
  late TierraavatarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TierraavatarModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'tierraavatar'});
  }
