...
import 'spadachin_model.dart';
export 'spadachin_model.dart';

class SpadachinWidget extends StatefulWidget {
  const SpadachinWidget({Key? key}) : super(key: key);

  @override
  _SpadachinWidgetState createState() => _SpadachinWidgetState();
}

class _SpadachinWidgetState extends State<SpadachinWidget>
    with TickerProviderStateMixin {
  late SpadachinModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SpadachinModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'spadachin'});
  }
