...
import 'bomb_model.dart';
export 'bomb_model.dart';

class BombWidget extends StatefulWidget {
  const BombWidget({Key? key}) : super(key: key);

  @override
  _BombWidgetState createState() => _BombWidgetState();
}

class _BombWidgetState extends State<BombWidget> with TickerProviderStateMixin {
  late BombModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BombModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'bomb'});
  }
