                                                  ...
                                                  child: Align(
                                                    alignment:
                                                        AlignmentDirectional(
                                                            -0.45, -0.3),
                                                    child: Image.asset(
                                                      'assets/images/Group_33980_(1).png',
                                                      fit: BoxFit.cover,
                                                    ),
                                                  ),
                                                ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '1zikhcro' /* Buy and view all your favorite... */,
                                            ),
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle2,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'b6heelhy' /* Keep track of all your purchas... */,
                                            ),
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle2,
