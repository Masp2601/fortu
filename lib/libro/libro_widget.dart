...
export 'libro_model.dart';

class LibroWidget extends StatefulWidget {
  const LibroWidget({Key? key}) : super(key: key);

  @override
  _LibroWidgetState createState() => _LibroWidgetState();
}

class _LibroWidgetState extends State<LibroWidget>
    with TickerProviderStateMixin {
  late LibroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LibroModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'libro'});
  }
