  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          logFirebaseEvent('M_Y_CARD_FloatingActionButton_mouyt1jp_O');
                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'M_Y_CARD_PAGE_Column_c2q9ab45_ON_TAP');
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'M_Y_CARD_PAGE_Column_fc5sips5_ON_TAP');
                            ...
                            children: List.generate(
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'M_Y_CARD_PAGE_transaction_ON_TAP');
