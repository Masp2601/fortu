...
import 'oracle_model.dart';
export 'oracle_model.dart';

class OracleWidget extends StatefulWidget {
  const OracleWidget({Key? key}) : super(key: key);

  @override
  _OracleWidgetState createState() => _OracleWidgetState();
}

class _OracleWidgetState extends State<OracleWidget>
    with TickerProviderStateMixin {
  late OracleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OracleModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'oracle'});
  }
