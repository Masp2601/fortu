...
import 'planeta_model.dart';
export 'planeta_model.dart';

class PlanetaWidget extends StatefulWidget {
  const PlanetaWidget({Key? key}) : super(key: key);

  @override
  _PlanetaWidgetState createState() => _PlanetaWidgetState();
}

class _PlanetaWidgetState extends State<PlanetaWidget>
    with TickerProviderStateMixin {
  late PlanetaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlanetaModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'planeta'});
  }
