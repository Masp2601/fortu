...
import 'espada_model.dart';
export 'espada_model.dart';

class EspadaWidget extends StatefulWidget {
  const EspadaWidget({Key? key}) : super(key: key);

  @override
  _EspadaWidgetState createState() => _EspadaWidgetState();
}

class _EspadaWidgetState extends State<EspadaWidget>
    with TickerProviderStateMixin {
  late EspadaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EspadaModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'espada'});
  }
