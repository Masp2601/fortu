...
import 'package:fortunators/screen/noventa_apuesta/disfruta_90.dart';
import 'package:fortunators/screen/treinta_apuesta/disfruta_30.dart';
import 'package:fortunators/widgets/snap_bar.dart';

class TablesNoventaPage extends StatefulWidget {
  const TablesNoventaPage({Key? key}) : super(key: key);

  @override
  State<TablesNoventaPage> createState() => _TablesNoventaPageState();
}

class _TablesNoventaPageState extends State<TablesNoventaPage> {
