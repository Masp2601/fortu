...
import 'package:fortunators/screen/noventa_apuesta/utils/game_utils.dart';
import 'package:fortunators/screen/treinta_apuesta/utils/game_utils.dart';

class GameNoventaPage extends StatefulWidget {
  const GameNoventaPage({Key? key}) : super(key: key);

  @override
  State<GameNoventaPage> createState() => _GameNoventaPageState();
}

class _GameNoventaPageState extends State<GameNoventaPage> {
  //setting text style
  TextStyle whiteText = TextStyle(color: Colors.white);
  bool hideTest = false;
  GameNoventa _game = GameNoventa();
