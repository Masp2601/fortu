...
class DisfrutaTreintaPage extends StatefulWidget {
  const DisfrutaTreintaPage({Key? key}) : super(key: key);

  @override
  State<DisfrutaTreintaPage> createState() => _DisfrutaTreintaPageState();
}

class _DisfrutaTreintaPageState extends State<DisfrutaTreintaPage> {
  ...
  device() {
    Future.delayed(const Duration(seconds: 2), () {
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (context) => GameTreintaPage()));
    });
  }
