...
import 'package:fortunators/screen/cincuenta_apuesta/fortunator_50.dart';
...
class DisfrutaCincuentaPage extends StatefulWidget {
  const DisfrutaCincuentaPage({Key? key}) : super(key: key);

  @override
  State<DisfrutaCincuentaPage> createState() => _DisfrutaCincuentaPageState();
}

class _DisfrutaCincuentaPageState extends State<DisfrutaCincuentaPage> {
  ...
  device() {
    Future.delayed(const Duration(seconds: 2), () {
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (context) => GameCincuentaPage()));
    });
  }
