...
import 'magnet_model.dart';
export 'magnet_model.dart';

class MagnetWidget extends StatefulWidget {
  const MagnetWidget({Key? key}) : super(key: key);

  @override
  _MagnetWidgetState createState() => _MagnetWidgetState();
}

class _MagnetWidgetState extends State<MagnetWidget>
    with TickerProviderStateMixin {
  late MagnetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MagnetModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'magnet'});
  }
