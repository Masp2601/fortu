...
class _EnergyWidgetState extends State<EnergyWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'energy'});
  }
