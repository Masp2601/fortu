...
import 'schema/basededatos_record.dart';
...
export 'schema/basededatos_record.dart';
...
/// Functions to query BasededatosRecords (as a Stream and as a Future).
Future<int> queryBasededatosRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BasededatosRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BasededatosRecord>> queryBasededatosRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<BasededatosRecord>> queryBasededatosRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<BasededatosRecord>> queryBasededatosRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
