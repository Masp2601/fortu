...
class _FlagWidgetState extends State<FlagWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'flag'});
  }
