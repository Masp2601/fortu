        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'brujula',
              requireAuth: true,
              builder: (context, params) => BrujulaWidget(),
            ),
            FFRoute(
              name: 'espejomagico',
              path: 'espejomagico',
              requireAuth: true,
              builder: (context, params) => EspejomagicoWidget(),
            ),
            FFRoute(
              name: 'magia',
              path: 'magia',
              requireAuth: true,
              builder: (context, params) => MagiaWidget(),
            ),
            FFRoute(
              name: 'libro',
              path: 'libro',
              requireAuth: true,
              builder: (context, params) => LibroWidget(),
            ),
            FFRoute(
              name: 'hielo',
              path: 'hielo',
              requireAuth: true,
              builder: (context, params) => HieloWidget(),
            ),
            FFRoute(
              name: 'obni',
              path: 'obni',
              requireAuth: true,
              builder: (context, params) => ObniWidget(),
            ),
            FFRoute(
              name: 'planet',
              path: 'planet',
